...
# # app/main.py
# # This code piece part of only with inline clickable links updated with chat-history. 
# # Can be use with inline clickable links elastic_utils and vector_db.py files
...
# # --- API and Helper Functions (no changes to these functions) ---
# def post_message_vertexai(input_text: str) -> str | None:
#     # ... (function is correct, no changes)
#     try:
#         vertexai.init(project=VERTEXAI_PROJECT, location=VERTEXAI_LOCATION)
